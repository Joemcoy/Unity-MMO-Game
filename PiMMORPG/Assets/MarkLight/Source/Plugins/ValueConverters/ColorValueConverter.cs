    ...
    public class ColorValueConverter : ValueConverter
    {
        ...
        public static Color? HexToColor(string hex)
        {
            ...
            if (trimmedValue.StartsWith("#"))
            {
                ...
                {
                    return new Color(
                        int.Parse(string.Format("{0}{0}", trimmedValue[1]), System.Globalization.NumberStyles.HexNumber) / 255f,
                        int.Parse(string.Format("{0}{0}", trimmedValue[2]), System.Globalization.NumberStyles.HexNumber) / 255f,
                        int.Parse(string.Format("{0}{0}", trimmedValue[3]), System.Globalization.NumberStyles.HexNumber) / 255f
                        );
                }
        ...
        public static Color? RGBAToColor(string color)
        {
            ...
            if (values.Length == 1)
            {
                var U = System.Convert.ToSingle(values[0], CultureInfo.InvariantCulture);

...
--
-- Dumping data for table `map_spawns`
--

LOCK TABLES `map_spawns` WRITE;
/*!40000 ALTER TABLE `map_spawns` DISABLE KEYS */;
INSERT INTO `map_spawns` VALUES (1,-469.166,76.6805,403.236,0,0,0,1),(2,-50.1916,389.583,-4.21625,0,0,0,1);
